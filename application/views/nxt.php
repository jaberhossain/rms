...
<head>
  ...
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo base_url("asset/bower_components/jvectormap/jquery-jvectormap.cs") ?>">
  <!-- Date Picker -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview">
              <a href="<?php echo base_url(). ?>#"><i class="fa fa-circle-o"></i> Level One
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                ...
                <li class="treeview">
                  <a href="<?php echo base_url(). ?>#"><i class="fa fa-circle-o"></i> Level Two
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
