...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url()."asset/" ?>index2.php" class="logo">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="<?php echo site_url()."asset/" ?>#">
                      <div class="pull-left">
          ...
          <li>
            <a href="<?php echo base_url()."asset/" ?>#" data-toggle="control-sidebar"><i class="fa fa-gears"></i></a>
          </li>
        </ul>
      </div>
    </nav>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url('index.php/welcome/home'); ?>"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a href="<?php echo base_url()."asset/" ?>index2.php"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="<?php echo base_url()."asset/" ?>#">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="<?php echo base_url()."asset/" ?>#revenue-chart" data-toggle="tab">Area</a></li>
              <li><a href="<?php echo base_url()."asset/" ?>#sales-chart" data-toggle="tab">Donut</a></li>
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              ...
              <div class="item">
                ...
                <p class="message">
                  <a href="<?php echo base_url()."asset/" ?>#" class="name">
            ...
            <div class="box-header">
              ...
              <div class="box-tools pull-right">
                <ul class="pagination pagination-sm inline">
                  <li><a href="<?php echo base_url()."asset/" ?>#">&laquo;</a></li>
                  <li><a href="<?php echo base_url()."asset/" ?>#">1</a></li>
                  <li><a href="<?php echo base_url()."asset/" ?>#">2</a></li>
                  <li><a href="<?php echo base_url()."asset/" ?>#">3</a></li>
                  <li><a href="<?php echo base_url()."asset/" ?>#">&raquo;</a></li>
                </ul>
              </div>
            </div>
            <!-- /.box-header -->
              ...
              <div class="pull-right box-tools">
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu pull-right" role="menu">
                    <li><a href="<?php echo base_url()."asset/" ?>#">Add new event</a></li>
                    <li><a href="<?php echo base_url()."asset/" ?>#">Clear events</a></li>
                    <li class="divider"></li>
                    <li><a href="<?php echo base_url()."asset/" ?>#">View calendar</a></li>
                  </ul>
                </div>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li><a href="<?php echo base_url()."asset/" ?>#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
      <li><a href="<?php echo base_url()."asset/" ?>#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
    <div class="tab-content">
      ...
      <div class="tab-pane" id="control-sidebar-home-tab">
        ...
        <ul class="control-sidebar-menu">
          <li>
            <a href="<?php echo base_url()."asset/" ?>javascript:void(0)">
      ...
      <div class="tab-pane" id="control-sidebar-settings-tab">
        <form method="post">
          ...
          <div class="form-group">
            <label class="control-sidebar-subheading">
              Delete chat history
              <a href="<?php echo base_url()."asset/" ?>javascript:void(0)" class="text-red pull-right"><i class="fa fa-trash-o"></i></a>
            </label>
          </div>
          <!-- /.form-group -->
        </form>
